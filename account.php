	...
	<body>		
		<div class="app-page" data-page="account">
			<div class="app-topbar">
				...
				<div class="app-button right accnt">缴费记录</div>
			</div>

			<div class="app-content">		
				<div style="margin:15px 0;">	
					<div style="margin-bottom:10px;">
						<div class="label" style="color:#888;padding-left:10px;">基本信息</div>
						<div class="schoolsub" style="background:#fff;height:40px;line-height:40px;padding:0 15px;border-bottom:1px solid #eee;"></div>
						<div class="phone" style="background:#fff;height:40px;line-height:40px;padding:0 15px;border-bottom:1px solid #eee;"></div>
						<div class="addr" style="background:#fff;height:40px;line-height:40px;padding:0 15px;border-bottom:1px solid #eee;"></div>
					</div>
					
					<!-- 一个账号可能多个小孩 -->
					<div style="margin-bottom:10px;">
						<div class="label" style="color:#888;padding-left:10px;">学生列表</div>
				   		 <ul class="app-list">
				   			<li>
				   				
								<span style="float:right;color:#888;">课程表 〉</span>
								<span class="studentName"></span>
								<span class="grade" style="color:#888;font-size:0.8em;"></span>
	    ...
	    <div class="app-page" data-page="accnt">
	      <div class="app-topbar">
	          <div class="app-button left" data-back data-autotitle></div>
			  <div class="app-title">缴费流水单</div>
	      </div>
	      <div class="app-content">
	    	<div class="list">
	    	  <div class="listItem">
	    	    <div class="title">
	    	    	<span class="accntType"></span>
					<span class="amount" style="float:right;"></span>
	    	    </div>
		...
		<div class="app-page" data-page="kclist">
			<div class="app-topbar">
		        <div class="app-button left" data-back data-autotitle></div>
				<div class="app-title">报读课程内容</div>
			</div>
			<div class="app-content">
				<div style="border-top:1px solid #eee;border-bottom:1px solid #eee;">
					<div class="app-button class" style="float:left;width:50%;background:#fff;">大小班</div>	
					<div class="app-button one2one" style="background:#eee;">一对一</div>	
				</div>
				...
				<div class="list">
		    	  <div class="listItem">
		    	    <div class="title">
						...
						<span class="hour" style="float:right;"></span>
		    	    </div>
		  			<div class="subtitle" style="color:#888;">
		  				<span class="timely"></span>
		    		</div>
					<!-- 隐藏id -->
		  			<div class="id" style="display:none;"></div>		
		    	  </div>
		...
		<script>
			...
			$.ajax({
			    ...
			    success: function(result){
					console.log(result.data) // 可能多个小孩
					if(result.success){
						App.load('account',{"many":result.data})
